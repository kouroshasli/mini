...
const animateOnScroll = () => {
    const elements = document.querySelectorAll('.skill-card, .project-card, .library-card, .about-text');
    ...
    elements.forEach((element, index) => {
        ...
        element.style.transition = `all 0.8s cubic-bezier(0.175, 0.885, 0.32, 1.275) ${index % 3 * 0.1}s`;
